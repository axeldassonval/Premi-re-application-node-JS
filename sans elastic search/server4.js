...
server.on('request', function(request,response) {//contient tous se qui doit tourner sure le serveur
	...
	fs.readFile('index4.html','utf-8',function(err,data){//indique le fichier que je veux appeller la en locurence index.html
		...
		listeDeCourses.push('Nouvel ingrédient');
